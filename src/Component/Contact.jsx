      ...
      <div className="md:w-2/3 mx-auto mb-20">
        ...
        >
          ...
          <div
            ...
            className="w-36 mx-auto border rounded-lg bg-red-600 border-blue-500 active:bg-red-800"
          >
            <input
              type="submit"
              value="Submit"
              className=" py-3  px-8 text-white font-medium rounded-b-md cursor-pointer inline-block w-full "
            />
          </div>
        </form>
      </div>
