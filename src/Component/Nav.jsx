...
const Nav = () => {
  ...
  return (
    <div
      className={`shadow-lg w-full fixed top-0 left-0 z-50  ${
        scrolling ? "bg-transparent" : "bg-sky-500"
      }`}
    >
      <div
      ...
      >
        <div className="flex items-center">
          <div className="font-bold text-2xl cursor-pointer flex items-center font-Poppins text-gray-800">
            ...
            >
              <img src={Logo} alt="Logo" className="w-8 h-8 filter grayscale" />
              RenDev
            </a>
          </div>
          <button
        ...
        <ul
          className={`md:flex md:items-center md:pb-0 pb-3 absolute md:static ${
            open ? "bg-red-500 " : "bg-transparent"
